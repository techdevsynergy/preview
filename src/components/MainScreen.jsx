...
const MainScreen = ({ flowItems, onStartAdd, onEditItem, renderItemDetails }) => (
  <div className="max-w-4xl mx-auto">
    <div className="flex justify-between items-center mb-6">
      <h1 className="text-3xl font-bold text-gray-900">Admin Content</h1>
      <button
        onClick={onStartAdd}
      ...
      {flowItems.length === 0 ? (
        ...
        <ul className="divide-y divide-gray-200">
          {flowItems.map((item, index) => (
            <li key={index} className="py-4 px-2 cursor-pointer hover:bg-gray-50" onClick={() => onEditItem(index)}>
